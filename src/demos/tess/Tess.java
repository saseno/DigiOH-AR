...
/**
 * tess.java This program demonstrates polygon tessellation. Two tesselated
 * objects are drawn. The first is a rectangle with a triangular hole. The
 * second is a smooth shaded, self-intersecting star.
 *
 ...
 * self-intersecting star. Also note that removing the TessProperty for the star
 * will make the interior unshaded (WINDING_ODD).
 * 
...
public class Tess {
	...
	public static class TessRenderer implements GLEventListener {
		...
		public void init(GLAutoDrawable drawable) {
			...
			double[][] rect = new double[][] { { 50.0, 50.0, 0.0 }, { 200.0, 50.0, 0.0 }, { 200.0, 200.0, 0.0 },
					{ 50.0, 200.0, 0.0 } };
			double[][] tri = new double[][] { { 75.0, 75.0, 0.0 }, { 125.0, 175.0, 0.0 }, { 175.0, 75.0, 0.0 } };
			double[][] star = new double[][] { { 250.0, 50.0, 0.0, 1.0, 0.0, 1.0 },
					{ 325.0, 200.0, 0.0, 1.0, 1.0, 0.0 }, { 400.0, 50.0, 0.0, 0.0, 1.0, 1.0 },
					{ 250.0, 150.0, 0.0, 1.0, 0.0, 0.0 }, { 400.0, 150.0, 0.0, 0.0, 1.0, 0.0 } };
	...
	public static class TessCallback extends com.jogamp.opengl.glu.GLUtessellatorCallbackAdapter {
		...
		public void combine(double[] coords, Object[] data, float[] weight, Object[] outData) {
			...
			vertex[2] = coords[2];
			for (i = 3; i < 6; i++)
				vertex[i] = weight[0] * ((double[]) data[0])[i] + weight[1] * ((double[]) data[1])[i]
