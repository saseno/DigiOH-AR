...
public class RunnerClass extends GlSketch {
	...
	public void draw(GL gl) throws Exception {
		...
		try {
			...
			render.drawBackground(gl, sensor.getSourceImage(), mirror, i_width, i_height);			
			render.loadARProjectionMatrix(gl, mirror);
